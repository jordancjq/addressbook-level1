...
public class AddressBook {
    ...
    private static final String MESSAGE_SORT_COMPLETE = "Address book has been sorted!";
    ...
    private static final String COMMAND_SORT_DESC = "Sorts all persons in address book by name in alphabetical order.";
     ...
     * The constants given below are the keys for the different data values of a person
     * used by the internal HashMap storage format.
     * For example, a person's name is stored as the PersonProperty.NAME key.
     */
    ...
    private static ArrayList<HashMap<PersonProperty, String>> getPersonsWithNameContainingAnyKeyword(Collection<String> keywords) {
        final Collection<String> lowerCaseKeywords = makeLowerCase(keywords);
        ...
        for (HashMap<PersonProperty, String> person : getAllPersonsInAddressBook()) {
            ...
            final Collection<String> lowerCaseWordsInName = makeLowerCase(wordsInName);
    ...
    /**
     * Transforms the given set of strings to lower case format
     *
     * @param toLowerCase collections of strings to be transformed
     * @return            collection of strings with lower case format
     */
    private static Collection<String> makeLowerCase(Collection<String> toLowerCase){
        Iterator<String> iterator = toLowerCase.iterator();
        Collection<String> lowerCaseNames = new HashSet<>();
        while (iterator.hasNext()){
            lowerCaseNames.add(iterator.next().toLowerCase());
        }
    ...
    /**
     * Sorts all persons in the address book based on alphabetical order.
     *
     * @return feedback display message for the operation result
     */
    private static String executeSortAddressBook() {
        sortAddressBook();
        return MESSAGE_SORT_COMPLETE;
    }
     ...
     *
     * @param exactPerson the actual person inside the address book to be deleted
    ...
    /**
     * Sorts all persons in the address book and saves changes to file.
     */
    private static void sortAddressBook() {
        Collections.sort(ALL_PERSONS, new Comparator<HashMap<PersonProperty, String>>() {
            @Override
